...
import squarOrange from "../../Assets/animated/squar-orange.png";
import squarWhite from "../../Assets/animated/squar-white.png";
import plus from "../../Assets/animated/plus.png";

import location from "../../Assets/animated/location.png";
import message from "../../Assets/animated/message.png";
import women from "../../Assets/animated/women.png";
import mobile from "../../Assets/animated/mobile.png";
import setting from "../../Assets/animated/setting.png";
import trueIcon from "../../Assets/animated/true.png";
...
function Body() {
  return (
    <>
      <div class="container container-afte-header">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-30">
            <div class="about-thumb-area">
              <ul>
                <li>
                  <img src={image1} class="image-one" alt="..." />
                </li>
                <li>
                  <img src={image2} class="image-two" alt="..." />
                </li>
                <li>
                  <img src={image3} class="image-three" alt="..." />
                </li>
                <li>
                  <div class="exp-bx">
      ...
      <section className=" working-process-area ptb-100">
        <div className="container-sm">
          <div className="header-title">
            <p className="working-process">Working Process</p>
            <p className="How-We-Works">How We Works ?</p>
          </div>
          <div class="row align-items-center show-three-col">
            <div class="col-lg-4 col-sm-6 mb-30">
              <div class="make-appointmnet">
                <h2>01</h2>
                ...
                <ViewMore pathname={"/home"} classname="make-appointmnet-btn" />
              </div>
            </div>
            <div class="col-lg-4 col-sm-6 mb-30">
              <div class="make-appointmnet active">
                <h2>02</h2>
          ...
          <img src={squarOrange} class="image-animated-orange" alt="..." />
          <img src={squarWhite} class="image-animated-white" alt="..." />
          <img src={plus} class="image-animated-plus" alt="..." />
        </div>
      </section>
      <section className="booking-area">
        <div className="container">
          <div className="row jusify-content-center">
            <div className="col-xl-5 col-lg-6 col-md-2">
              <div className="booking-form-area">
                <Booking widthPage="90%" />
              </div>
            </div>
            <div className="col-xl-7 col-lg-6 col-md-6">
              <div className="appointment-thumb">
                <img className="img-responsive" src={mobile} alt="" />
                <div class="images-group">
                  <img className="img1" src={women} alt="" />
                  <img className="img2" src={location} alt="" />
                  <img className="img3" src={message} alt="" />
                  <img className="img4" src={setting} alt="" />
                  <img className="img5" src={trueIcon} alt="" />
                </div>
              </div>
            </div>
          </div>
